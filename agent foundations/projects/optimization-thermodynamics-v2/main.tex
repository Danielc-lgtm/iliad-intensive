...
The argument of Section~\ref{sec:prediction} has a payoff worth stating, because it answers a standing objection to treating ``optimization'' or ``intelligence'' as a real feature of the world at all.
...
At the great equilibrium successes of thermodynamics this exogeneity is harmless, because the right $\mu$ is essentially forced. But it pays to see exactly what ``harmless'' requires. Call $\mu$ a \emph{useful summary} of an actual physical state $x$ when three conditions hold:
\begin{enumerate}[leftmargin=2em]
