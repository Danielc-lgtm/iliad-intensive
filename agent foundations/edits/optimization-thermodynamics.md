...
*(Prose clarified and simplified per author request -- shorter sentences, plainer wording -- with the structure, derivations, and equations unchanged. The rest of the document was reverted to the previous version before this edit.)*
